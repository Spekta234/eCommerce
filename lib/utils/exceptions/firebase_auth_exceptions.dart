  ...
  String get message {
    switch (code) {
      ...
      case 'email-already-in-use':
        return 'The email is registered. Please use a different email.';
      case 'wrong-password':
        return 'Incorrect password. Please check your password and try again.';
      case 'weak-password':
        return 'The password is too weak. Please choose a stronger password.';
      case 'provider-linked-already':
      ...
      case 'invalid-app-credential':
        return 'An app credential is invalid. Please provide a valid app credential.';
      case 'user-mismatch':
      ...
      case 'user-token-mismatch':
        return 'The provider user\'s token has a mismatch with the authentication user\'s user ID';
      case 'invalid-message-payload':
        return 'The email template verification message payload is invalid.';
      case 'invalid-sender':
        return 'The email template sender is invalid. Please verify sender\'s email';
      case 'invalid-recipient-email':
        return 'The recipient email is invalid. Please verify recipient\'s email';
      ...
      default:
        return 'An unexpected Firebase authentication error occurred. Please try again.';
    }
  }
}