...
class EFormatException implements Exception{
  ...
  const EFormatException([this.message = 'An unexpected error occurred. Please check your input.']);
  ...
  factory EFormatException.fromCode(String code) {
    switch (code) {
      ...
      case 'invalid-phone-number-format':
        return const EFormatException('The provided phone number format is invalid. Please enter a valid phone number.');
      ...
      case 'invalid-credit-card-format':
        return const EFormatException('The credit card number format is invalid. Please enter a valid credit card number.');
